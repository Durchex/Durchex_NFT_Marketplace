                      ...
                      {creator.verificationType === 'gold' && (
                        ...
                        >
                          <svg viewBox="0 0 24 24" className="w-5 h-5" aria-hidden="true">
                            ...
                            <path d="M12 2 L20 7 L20 17 L12 22 L4 17 L4 7 Z" fill="url(#goldGrad)" stroke="#E6B800" strokeWidth="1.25"/>
                              ...
                              <svg viewBox="0 0 24 24" className="w-4 h-4" aria-hidden="true">
                                {creator.verificationType === 'gold' ? (
                                  <>
                                    ...
                                    <path d="M12 2 L20 7 L20 17 L12 22 L4 17 L4 7 Z" fill="url(#goldGradInline)" stroke="#E6B800" strokeWidth="1.25"/>
                                  </>
                                ) : (
                                  <path d="M12 2 L20 7 L20 17 L12 22 L4 17 L4 7 Z" fill="#ffffff" stroke="#E5E7EB" strokeWidth="1.25"/>
                                )}
