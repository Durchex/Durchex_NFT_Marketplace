...
/**
 * @title DurchexGovernor
 * @dev Governance contract for Durchex DAO
 */
contract DurchexGovernor is
    Governor,
    GovernorSettings,
    ...
    GovernorTimelockControl
{
    ...
    constructor(IVotes _token, TimelockController _timelock)
        Governor("DurchexGovernor")
        GovernorSettings(
            1, // 1 block voting delay
            50400, // 1 week voting period (~50400 blocks at 12s/block)
            10_000e18 // 10,000 tokens minimum to propose
        )
